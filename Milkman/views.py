...
from .serializers import MilkmanSerializer


# Create your views here.
# ---------------- Milkman ViewSet ----------------
class MilkmanViewSet(viewsets.ModelViewSet):
    queryset = Milkman.objects.all()
    serializer_class = MilkmanSerializer
    ...
    def destroy(self, request, pk=None):
        ...
        vendor.delete()
        return Response(
            {"message": "Milkman deleted"}, status=status.HTTP_204_NO_CONTENT
        )
